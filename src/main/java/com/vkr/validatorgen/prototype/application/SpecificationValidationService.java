...
import com.vkr.validatorgen.prototype.model.ValidationResult;

import java.util.List;

public interface SpecificationValidationService {
    ValidationResult validate(DtoDescriptor dto, List<RuleSpec> rules, GenerationMode mode);
}
